...
**OBEWISE** — outcomes-based education platform at Caraga State University.
...
**PCA Payroll Management System** — payroll system for the Philippine Coconut
Authority. React.js, TypeScript, Laravel, PostgreSQL. I was project manager and
built the admin side, covering for teammates on unfamiliar parts of the stack.

**TIFARMS** — mobile app for the Tipusuan Farmers Association to manage finances
and generate the reports their treasurer files with the Department of
Agriculture and the BIR. React Native, Laravel, PostgreSQL, SQLite.
...
- **AutomataSimulator-NoRepeatedStrings** — automata simulator for strings
  with no repeated substrings.
